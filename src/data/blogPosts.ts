...
export const blogCategories: BlogCategory[] = [
  ...
  },
  {
    ...
    description: 'Expert guides on appealing denied claims, disputing settlements, and navigating insurance disputes.',
  },
  {
    slug: 'healthcare',
    name: 'Healthcare & Medical Billing',
    description: 'Advice on disputing medical bills, insurance denials, coding errors, and provider complaints.',
  },
  {
    slug: 'utilities',
    name: 'Utilities & Telecommunications',
    description: 'Tips for resolving billing errors, service quality issues, and telecom contract disputes.',
  },
  {
    slug: 'vehicle',
    name: 'Vehicle & Auto',
    description: 'Guides for dealer complaints, warranty disputes, lemon law claims, and repair issues.',
  },
  {
    slug: 'employment',
    name: 'Employment & Workplace',
    description: 'Resources for addressing wage issues, workplace discrimination, and termination disputes.',
  },
  {
    slug: 'housing',
    name: 'Landlord & Housing',
    description: 'Practical advice for tenants on repairs, deposits, safety issues, and letting agent disputes.',
  },
  {
    slug: 'travel',
    name: 'Travel & Transportation',
    description: 'How to claim compensation for flight delays, lost baggage, and booking issues.',
  },
  {
    slug: 'financial',
    name: 'Financial Services',
    description: 'Guides on challenging bank fees, credit report errors, debt collection, and identity theft.',
  },
  {
    slug: 'ecommerce',
    name: 'E-commerce & Online Services',
    description: 'Help with seller disputes, account problems, data privacy requests, and online refunds.',
  },
  {
    slug: 'hoa',
    name: 'Neighbor & HOA Disputes',
    description: 'Advice on community issues, fee disputes, neighbor conflicts, and HOA governance.',
  },
  {
    slug: 'contractors',
  ...
  {
    slug: 'complaint-guides',
    name: 'Complaint Guides',
    description: 'Step-by-step guides for filing effective complaints and resolving disputes.',
  },
  {
    slug: 'legal-tips',
    name: 'Legal Tips',
