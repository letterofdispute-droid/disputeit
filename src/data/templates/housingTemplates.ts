...
const coreHousingTemplates: LetterTemplate[] = [
  {
    ...
    fields: [
      ...
      { id: 'repairIssue', label: 'Repair Issue Description', type: 'textarea', required: true },
  ...
  },
  {
    ...
    fields: [
      ...
      { id: 'heatingType', label: 'Heating System Type', type: 'select', options: ['Gas Central Heating', 'Electric Heating', 'Oil Heating', 'Heat Pump', 'Other'], required: true },
      { id: 'heatingIssue', label: 'Heating Problem', type: 'textarea', required: true },
  ...
  },
  {
    ...
    fields: [
      ...
      { id: 'propertyCity', label: 'City', type: 'text', required: true },
      { id: 'propertyPostcode', label: 'Postcode', type: 'text', required: true },
      { id: 'totalDeposit', label: 'Total Deposit', type: 'text', required: true },
      { id: 'amountDeducted', label: 'Amount Deducted', type: 'text', required: true },
      { id: 'deductionReasons', label: 'Stated Reasons', type: 'textarea', required: true },
      { id: 'disputeReasons', label: 'Why You Dispute', type: 'textarea', required: true },
    ],
    sections: [
  ...
  },
  {
    ...
    fields: [
      ...
      { id: 'propertyCity', label: 'City', type: 'text', required: true },
      { id: 'propertyPostcode', label: 'Postcode', type: 'text', required: true },
      { id: 'currentRent', label: 'Current Rent', type: 'text', required: true },
      { id: 'proposedRent', label: 'Proposed New Rent', type: 'text', required: true },
      { id: 'disputeReasons', label: 'Reasons for Dispute', type: 'textarea', required: true },
    ],
    sections: [
  ...
  },
  {
    ...
    fields: [
      ...
      { id: 'propertyCity', label: 'City', type: 'text', required: true },
      { id: 'propertyPostcode', label: 'Postcode', type: 'text', required: true },
      { id: 'harassmentType', label: 'Type of Harassment', type: 'select', options: ['Unlawful entry', 'Verbal abuse', 'Threats', 'Utility interference', 'Intimidation', 'Other'], required: true },
      { id: 'harassmentDescription', label: 'Description', type: 'textarea', required: true },
      { id: 'incidentDates', label: 'Dates of Incidents', type: 'text', required: true },
    ],
    sections: [
