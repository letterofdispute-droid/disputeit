...
const coreHoaTemplates: LetterTemplate[] = [
  {
    ...
    fields: [
      { id: 'hoaName', label: 'HOA/Management Company Name', type: 'text', required: true, placeholder: 'Enter HOA or management company name', impactLevel: 'important', aiEnhanced: true },
      { id: 'memberName', label: 'Your Name (as registered)', type: 'text', required: true, placeholder: 'Your name as it appears on HOA records', impactLevel: 'critical' },
      { id: 'memberId', label: 'Member/Account ID', type: 'text', required: false, placeholder: 'Your HOA member or account number', impactLevel: 'helpful', evidenceHint: 'Find on HOA statements or correspondence' },
      { id: 'unitNumber', label: 'Unit/Lot Number', type: 'text', required: true, placeholder: 'e.g., Unit 5, Lot 23', impactLevel: 'important' },
      { id: 'complaintType', label: 'Type of Complaint', type: 'select', required: true, options: ['Maintenance/repairs', 'Noise/nuisance', 'Parking issues', 'Common area problems', 'Rule enforcement', 'Communication issues', 'Financial/billing', 'Other'], impactLevel: 'critical', aiEnhanced: true },
      { id: 'complaintDetails', label: 'Complaint Details', type: 'textarea', required: true, placeholder: 'Describe the issue in detail', impactLevel: 'critical', aiEnhanced: true },
    ],
    sections: [
  ...
  },
  {
    ...
    fields: [
      ...
      { id: 'unitNumber', label: 'Unit/Lot Number', type: 'text', required: true, placeholder: 'e.g., Lot 15', impactLevel: 'important' },
      { id: 'modificationType', label: 'Type of Modification', type: 'select', required: true, options: ['Exterior paint', 'Fencing', 'Landscaping', 'Deck/patio', 'Solar panels', 'Roof', 'Windows/doors', 'Addition', 'Other'], impactLevel: 'critical', aiEnhanced: true },
      { id: 'modificationDescription', label: 'Description', type: 'textarea', required: true, placeholder: 'Describe the proposed changes', impactLevel: 'critical', aiEnhanced: true, evidenceHint: 'Include materials, colors, dimensions, contractor info' },
      { id: 'proposedStartDate', label: 'Proposed Start Date', type: 'date', required: true, impactLevel: 'important' },
    ],
    sections: [
