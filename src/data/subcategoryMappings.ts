...
const subcategoryPatterns: Record<string, { pattern: RegExp | string; subcategory: SubcategoryInfo }[]> = {
  ...
  'Financial': [
    { pattern: /bank|account|checking|savings|atm|branch|overdraft|wire-transfer|nsf|fund-availability/, subcategory: { name: 'Banking', slug: 'banking' } },
    { pattern: /credit-card|charge|statement|interest|apr|billing-error|rewards|promotional/, subcategory: { name: 'Credit Cards', slug: 'credit-cards' } },
