...
const ArticlePage = () => {
  ...
  const post =
    ...
    (staticPost
      ...
      : null);
  const relatedPosts =
    dbRelatedPosts && dbRelatedPosts.length > 0
      ? dbRelatedPosts
  ...
  const sanitizedContent = useMemo(() => {
    ...
    if (post.middle_image_1_url) {
      if (hasPlaceholder1) {
        ...
        html = html.replace(
          /{{MIDDLE_IMAGE_1}}/g,
          `<figure class="article-middle-image"><img src="${post.middle_image_1_url}" alt="${alt1.replace(/"/g, "&quot;")}" loading="lazy" /></figure>`,
        );
      } else {
        ...
        if (midPoint > 0 && paragraphs.length > 3) {
          ...
          paragraphs.splice(
            midPoint,
            0,
            `</p><figure class="article-middle-image"><img src="${post.middle_image_1_url}" alt="${alt1.replace(/"/g, "&quot;")}" loading="lazy" /></figure><p>`,
          );
    ...
    if (post.middle_image_2_url) {
      if (hasPlaceholder2) {
        ...
        html = html.replace(
          /{{MIDDLE_IMAGE_2}}/g,
          `<figure class="article-middle-image"><img src="${post.middle_image_2_url}" alt="${alt2.replace(/"/g, "&quot;")}" loading="lazy" /></figure>`,
        );
        ...
        if (insertPoint > 0 && paragraphs.length > 5) {
          ...
          paragraphs.splice(
            insertPoint,
            0,
            `</p><figure class="article-middle-image"><img src="${post.middle_image_2_url}" alt="${alt2.replace(/"/g, "&quot;")}" loading="lazy" /></figure><p>`,
          );
          html = paragraphs.join("</p>");
        }
      }
    ...
    post?.content,
    post?.middle_image_1_url,
    post?.middle_image_2_url,
    post?.middle_image_1_alt,
    post?.middle_image_2_alt,
    post?.title,
  ]);
  ...
  const authorInitials = authorData
    ? authorData.name
        .split(" ")
        .map((n) => n[0])
        .join("")
  ...
  const authorBio =
    authorData?.shortBio ||
    "Our editorial team at Letter Of Dispute helps consumers navigate disputes with clear, actionable guidance.";
      ...
      <section className="bg-muted/50 py-4 border-b border-border">
        <div className="container-wide">
          <nav className="flex items-center gap-2 text-sm flex-wrap">
            ...
            <ChevronRight className="h-4 w-4 text-muted-foreground" />
            <Link
              to={`/articles/${post.category_slug}`}
        ...
        <div className="container-wide py-12 md:py-16 lg:py-20">
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <div className="order-2 md:order-1">
              ...
              {post.excerpt && (
                <p className="text-white/70 text-lg md:text-xl mb-8 leading-relaxed max-w-lg">{post.excerpt}</p>
              )}
        ...
        <div className="container-wide">
              ...
              <div className="mt-12 p-8 bg-muted/50 rounded-2xl border border-border">
                <div className="flex items-start gap-5">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-muted-foreground leading-relaxed">{authorData?.bio || authorBio}</p>
            ...
            <aside className="hidden lg:block w-72 shrink-0">
              <div className="sticky top-20 space-y-6">
                ...
                <div className="p-5 bg-accent/10 rounded-xl border border-accent/20">
                  <h3 className="font-serif font-bold text-foreground mb-2">Need a Letter Template?</h3>
                  ...
                  <Button variant="accent" size="sm" asChild className="w-full">
                    <Link to="/#letters">Browse Templates</Link>
                  </Button>
                </div>
              </div>
            </aside>
          ...
          <div className="mt-16 max-w-3xl mx-auto lg:mx-0 p-8 md:p-10 bg-gradient-to-br from-primary to-primary/90 rounded-2xl text-center">
            ...
            <p className="text-primary-foreground/80 mb-8 max-w-lg mx-auto">
              Use our professionally written templates to create a formal complaint letter backed by UK consumer rights
              law.
            </p>
            <Button
              size="lg"
        ...
        <section className="py-16 md:py-20 bg-muted/30">
          <div className="container-wide">
            <div className="flex items-center justify-between mb-10">
              <h2 className="font-serif text-2xl md:text-3xl font-bold text-foreground">Related Articles</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {relatedPosts.map((relatedPost) => (
                <Card
                  ...
                  className="group hover:shadow-lg transition-all duration-300 overflow-hidden border-border"
                >
