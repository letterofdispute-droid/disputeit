...
const PrivacyPage = () => {
  ...
  const tableOfContents = [
    ...
    { id: "gdpr-rights", title: "8. GDPR Rights (EU Residents)" },
    { id: "ccpa-rights", title: "9. CCPA Rights (California Residents)" },
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            ...
            <section id="introduction" className="scroll-mt-24">
              ...
              <p>
                DisputeLetters ("we," "us," or "our") is committed to protecting your privacy and ensuring you understand how we collect, use, and safeguard your personal information. This Privacy Policy explains our data practices for our website at disputeletters.com (the "Service").
              </p>
              <p>
            ...
            <section id="information-we-collect" className="scroll-mt-24">
              ...
              <ul>
                ...
                <li><strong>Cookies:</strong> Small data files stored on your device (see Section 10 for details)</li>
              </ul>
            ...
            <section id="your-rights" className="scroll-mt-24">
              ...
              <p>To exercise any of these rights, contact us at privacy@disputeletters.com.</p>
            </section>

            {/* Section 8 - GDPR */}
            <section id="gdpr-rights" className="scroll-mt-24">
              <h2>8. GDPR Rights (EU Residents)</h2>
            ...
            <section id="ccpa-rights" className="scroll-mt-24">
              <h2>9. CCPA Rights (California Residents)</h2>
              ...
              <p>
                <strong>Do Not Sell My Personal Information:</strong> DisputeLetters does not sell, rent, or trade your personal information to third parties for monetary or other valuable consideration. Therefore, we do not offer an opt-out for the sale of personal information.
              </p>
          ...
          <div className="bg-muted rounded-lg p-6 mt-8">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm">
                  <strong>Email:</strong>{" "}
                  <a href="mailto:privacy@disputeletters.com" className="text-primary hover:underline">
                    privacy@disputeletters.com
                  </a>
                </p>
                <p className="text-sm mt-1">
                  <strong>Response Time:</strong> We aim to respond within 30 days (GDPR) or 45 days (CCPA)
                </p>
              </div>
            </div>
          </div>
