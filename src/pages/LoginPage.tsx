              ...
              >
                {isAppleLoading ? (
                  ...
                  <svg className="h-4 w-4 mr-2" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M17.05 20.28c-.98.95-2.05.8-3.08.35-1.09-.46-2.09-.48-3.24 0-1.44.62-2.2.44-3.06-.35C2.79 15.25 3.51 7.7 9.05 7.4c1.3.07 2.19.74 2.94.77 1.12-.22 2.18-.91 3.39-.84 1.44.1 2.52.64 3.24 1.6-2.97 1.78-2.27 5.69.42 6.75-.52 1.37-1.18 2.72-1.99 4.6zM12.03 7.25c-.15-2.23 1.66-4.07 3.74-4.25.29 2.58-2.34 4.5-3.74 4.25z" />
                  </svg>
                )}
                Continue with Apple
              </Button>
